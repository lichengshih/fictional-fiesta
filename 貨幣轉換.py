...
class Main(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Create title label
        self.title_label = Label(self, text='貨幣轉換小幫手', bg='#3A3B3C', fg='white', font=('time new roman', 20), relief='sunken')
        self.title_label.place(x=200, y=35, anchor='center')

        # Create date label
        self.date_label = Label(self, text=f'目前時間為: {dt.datetime.now():%Y 年 %m 月 %d 日 %H 時 %M 分}', bg='#3A3B3C', fg='white', font=('time new roman', 10))
        self.date_label.place(x=0, y=400, anchor='sw')

        # Create amount label
        self.amount_label = Label(self, text='請輸入金額: ', bg='#3A3B3C', fg='white', font=('time new roman', 15))
        ...
        # Create 'from' label
        self.base_currency_label = Label(self, text='From: ', bg='#3A3B3C', fg='white', font=('time new roman', 15))
        self.base_currency_label.place(x=200, y=140, anchor='center')

        # Create 'to' label
        self.destination_currency_label = Label(self, text='To: ', bg='#3A3B3C', fg='white', font=('time new roman', 15))
        ...
        self.convert_button = Button(self, text='轉換', bg='#52595d', fg='black', command=self.processed)
        self.convert_button.place(x=170, y=270, anchor='center')

        # Create 'clear' button
        self.clear_button = Button(self, text='清除', bg='#52595d', fg='black', command=self.clear)
    ...
    def processed(self):
        ...
        # Create warning message box
            ...
            convert_error = messagebox.showwarning('WARNING!', '請輸入正確資訊 (限數字)！')
